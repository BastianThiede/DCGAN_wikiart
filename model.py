...
def generator(input_dim=100,units=1024,activation='relu'):
    ...
    # FC: 2x2x512
    generator.add(Dense(2*2*256,input_shape=(input_dim,), kernel_initializer=init))
...
def discriminator(input_shape=(32, 32, 3),nb_filter=64):
    ...
    discriminator.add(Conv2D(32, input_shape=(64, 64, 3), kernel_size=5, strides=2, padding='same',
